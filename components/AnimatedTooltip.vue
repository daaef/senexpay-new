  ...
  <div class="random-shape-container">
    ...
    >
      ...
      <img
          :src="item.image"
          :alt="item.name"
          class="relative !m-0 size-16 rounded-full border-2 border-accent/30 object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105"
      />
    </div>
  </div>
</template>
